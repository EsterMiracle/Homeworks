...
class Error:
    ...
    def user_input(self):
        while True:
            try:
                val = int(input("Введите целое число и нажмите Enter: "))
                self.my_list.append(val)
                print(f"Текущий список: {self.my_list} \n ")
            except:
                print(f"Недопустимое значение! (Необходимо ввести только целые числа)")
                y_or_n = input(f"Начать заного? Y/N :")

                if y_or_n == "Y" or y_or_n == "y":
                    print(try_except.user_input())
                elif y_or_n == "N" or y_or_n == "n":
                    return f"Вы закончили сессию."
                else:
                    return f"Вы закончили сессию."
